  ...
  return (
    <div className="w-full">
      ...
      <div className="relative overflow-hidden rounded-2xl mx-4 my-4 shadow-2xl">
        ...
        {/* Transparencia con color específico #FFCC00 sobre la imagen para mejor legibilidad */}
        <div className="absolute inset-0" style={{ backgroundColor: '#FFCC0030' }}></div>
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-10 left-10 w-32 h-32 bg-white/20 rounded-full blur-xl"></div>
          <div className="absolute bottom-10 right-20 w-48 h-48 rounded-full blur-2xl" style={{ backgroundColor: '#FFCC0040' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-3xl" style={{ backgroundColor: '#FFCC0025' }}></div>
        </div>
