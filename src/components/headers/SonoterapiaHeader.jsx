...
import { Search, ShoppingCart, User, LogOut, Settings, Globe, Headphones, Volume2, VolumeX, ArrowLeft } from 'lucide-react';
...
const SonoterapiaHeader = ({ 
  ...
  return (
    <div className="w-full">
      {/* Header principal con gradiente verde/natural */}
      <div className="relative overflow-hidden rounded-2xl mx-4 my-4 shadow-2xl">
        ...
        {/* Transparencia con color específico #9C27B0 (Morado) sobre la imagen para mejor legibilidad */}
        <div className="absolute inset-0" style={{ backgroundColor: '#9C27B040' }}></div>
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-10 left-10 w-32 h-32 bg-white/20 rounded-full blur-xl"></div>
          <div className="absolute bottom-10 right-20 w-48 h-48 rounded-full blur-2xl" style={{ backgroundColor: '#9C27B030' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 rounded-full blur-3xl" style={{ backgroundColor: '#9C27B020' }}></div>
        </div>
          ...
          <div className="flex justify-between items-start">
            ...
            <div>
              ...
              <p className="text-xl text-white font-medium drop-shadow-2xl">
                Armoniza tu ser con vibraciones sanadoras 🎵
              </p>
            ...
            <div className="flex flex-col items-end space-y-4">
              {/* Stats del usuario */}
              <div className="flex items-center space-x-4 text-white/90 bg-white/15 backdrop-blur-sm px-6 py-4 rounded-xl border-l-4" style={{ borderLeftColor: '#BB46D6' }}>
              ...
              <div className="flex items-center space-x-3">
                {/* Idioma */}
                <LanguageSelector inline variant="header" colorClasses="flex items-center space-x-2 bg-purple-900 hover:bg-purple-800 border-2 border-purple-700 hover:border-purple-600 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105" />
