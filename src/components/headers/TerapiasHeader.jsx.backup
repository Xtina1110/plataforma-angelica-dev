        ...
        <div className="relative z-10 px-8 py-16">
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col items-end space-y-4">
              ...
              <div className="flex items-center space-x-3 bg-white/15 backdrop-blur-sm px-4 py-3 rounded-xl border-l-4 border-pink-400">
                ...
                <button 
                  onClick={onLogout}
                  className="p-2 hover:bg-white/20 rounded-lg transition-all duration-200 text-pink-200 hover:text-red-200"
