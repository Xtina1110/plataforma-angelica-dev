          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col items-end space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button 
                  onClick={onCartClick}
                  className="relative flex items-center space-x-2 bg-blue-900 hover:bg-blue-800 border-2 border-blue-700 hover:border-blue-600 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
                ...
                <button 
                  ...
                  className="flex items-center space-x-2 bg-blue-900 hover:bg-blue-800 border-2 border-blue-700 hover:border-blue-600 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
