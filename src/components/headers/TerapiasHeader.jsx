...
import { Search, ShoppingCart, User, LogOut, Settings, Globe, Zap, Volume2, VolumeX, ArrowLeft } from 'lucide-react';
...
const TerapiasHeader = ({ 
  ...
  return (
    <div className="w-full">
      {/* Header principal con gradiente violeta/sanación */}
      <div className="relative overflow-hidden rounded-2xl mx-4 my-4 shadow-2xl">
        {/* Fondo con imagen angélica y degradación violeta */}
        <div 
        ...
        {/* Transparencia rosa sobre la imagen para mejor legibilidad */}
        <div className="absolute inset-0 bg-pink-600/40"></div>
        <div className="absolute inset-0 opacity-30">
          <div className="absolute top-10 left-10 w-32 h-32 bg-white/20 rounded-full blur-xl"></div>
          <div className="absolute bottom-10 right-20 w-48 h-48 bg-pink-400/30 rounded-full blur-2xl"></div>
          ...
          <div className="flex justify-between items-start">
            ...
            <div>
              ...
              <p className="text-xl text-white font-medium drop-shadow-2xl">
                Libera tu espíritu de cargas energéticas ✨
              </p>
            ...
            <div className="flex flex-col items-end space-y-4">
              {/* Stats del usuario */}
              <div className="flex items-center space-x-4 text-white/90 bg-white/15 backdrop-blur-sm px-6 py-4 rounded-xl border-l-4 border-pink-400">
              ...
              <div className="flex items-center space-x-3">
                ...
                <button 
                  onClick={onCartClick}
                  className="relative flex items-center space-x-2 bg-pink-800 hover:bg-pink-700 border-2 border-pink-600 hover:border-pink-500 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
                ...
                <button 
                  ...
                  className="flex items-center space-x-2 bg-pink-800 hover:bg-pink-700 border-2 border-pink-600 hover:border-pink-500 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
