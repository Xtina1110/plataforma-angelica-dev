          ...
          <div className="flex justify-between items-start">
            ...
            <div className="flex flex-col items-end space-y-4">
              ...
              <div className="flex items-center space-x-3">
                {/* Idioma */}
                <LanguageSelector inline variant="header" colorClasses="flex items-center space-x-2 bg-orange-800 hover:bg-orange-700 border-2 border-orange-600 hover:border-orange-500 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105" />
                
                {/* Carrito */}
                <button 
                  onClick={onCartClick}
                  className="relative flex items-center space-x-2 bg-orange-800 hover:bg-orange-700 border-2 border-orange-600 hover:border-orange-500 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
                ...
                <button 
                  ...
                  className="flex items-center space-x-2 bg-orange-800 hover:bg-orange-700 border-2 border-orange-600 hover:border-orange-500 text-white px-5 py-3 rounded-xl transition-all duration-300 font-semibold shadow-xl hover:shadow-2xl hover:scale-105"
