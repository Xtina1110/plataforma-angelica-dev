...
const RegisterPageLayout = ({ 
  ...
  return (
    <div className="min-h-screen relative">
      {/* Fondo principal - igual que login */}
      <div 
      ...
      {/* Imagen San Miguel Arcángel centrada */}
      <div
        className="absolute inset-0 bg-no-repeat bg-center bg-cover opacity-60 z-10"
      ...
      <div className="relative z-30 py-8 px-4">
        <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl w-full max-w-4xl mx-auto border border-white/20 mb-8">
